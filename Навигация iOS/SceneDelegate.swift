...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    //    }
    //
    //    (UIApplication.shared.connectedScenes.first?.delegate as? SceneDelegate)?.changeViewConroller(viewController: SecondViewController(), animated: true, animationOptions: .transitionFlipFromBottom)
    //
    //}
